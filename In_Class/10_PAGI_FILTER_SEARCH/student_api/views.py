...
from django_filters.rest_framework import DjangoFilterBackend   #todo bunu kullanacaksam settingdekini yoruma alacam ardindan 237. satiri da eklicem buradaki 
from rest_framework.filters import SearchFilter,OrderingFilter
class StudentMVS(ModelViewSet):
    queryset = Student.objects.all()
    serializer_class = StudentSerializer
    pagination_class = MyNumberPagination         #!paginationlar pagination.py de tanimlanip burada kullaniliyor. 
    # pagination_class = MyLimitPagination
    # pagination_class = MyCursorPagination

    #todo burada eksik var
    # def get_queryset(self):
    #     queryset = Student.objects.all()
    #     path=self.request.query_params.get("path")        #! istekteki key
    #     if path:
    ...
    search_fields = ["first_name",]                         #! search butonu acioyor browsable apide.
