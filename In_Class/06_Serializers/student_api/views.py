...
# # todo urls olusturduktan sonra buraya gel   ##############   5
# from django.http import HttpResponse   #todo ######   6
# # Create your views here.

# def home(request):
#     return HttpResponse("<h1>API PAGE</h1>")       #todo ################ 7
...
@api_view(['GET', 'POST'])   #todo decarator
