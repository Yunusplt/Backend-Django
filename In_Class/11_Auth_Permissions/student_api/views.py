...
from rest_framework.permissions import IsAuthenticated, AllowAny, IsAdminUser   #!0108_1

class StudentMVS(ModelViewSet):
    queryset = Student.objects.all()
    serializer_class = StudentSerializer
    # permission_classes = [IsAuthenticated]                         #!0108_2  #setting.py daki global permissionu yoruma aldik. simdi studentte erisim yok. path de hala erisim var. 
    permission_classes = [IsAdminUser]                         #!0108_2  #setting.py daki global permissionu yoruma aldik. simdi studentte erisim yok. path de hala erisim var. 
...
class PathMVS(ModelViewSet):
    ...
    permission_classes = [AllowAny]                 #!0108_2  # herkes erisebilir. 
