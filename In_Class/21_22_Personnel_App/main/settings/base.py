...
#! 1708 Kendi modelinizi kullanacaksaniz.
# AUTH_USER_MODEL = "users.MyUser"

#! 1708 for image -------------------
#? MEDIA_URL='/media/'  hocada
MEDIA_URL='pictures/'
# MEDIA_ROOT=BASE_DIR /"pictures"
MEDIA_ROOT=BASE_DIR   #! picture folder icinde picture folder olusmasini engellemek icin 
#!-----------------------------------